...
from HW08_Rohan_Ratwani import date_arithmetic, file_reader, FileAnalyzer


class HW08_Testcases(unittest.TestCase):
    def test_date_arithmetic(self):
        '''The function tests date_artihmetic function'''
    ...
    def test_fileanalyzer(self):
        """The function tests the Fileanalyzer class which gives scans directory and gives filename, number of classes, methods, lines and characters"""
        fa: FileAnalyzer = FileAnalyzer("R:\Stevens\Sem-2\SSW-810\HW_08_Rohan_Ratwani\Ronnie")
