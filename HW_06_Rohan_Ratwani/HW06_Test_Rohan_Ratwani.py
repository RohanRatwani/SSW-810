import unittest
from HW_06_Rohan_Ratwani import  list_difference, list_intersect, list_copy, remove_vowels, check_pwd, DonutQueue
...
class MyTestCase(unittest.TestCase):
    ...
    def test_remove_vowels(self):
        ...
        self.assertEqual(remove_vowels("I am Rohan Ratwani"), "Rohan Ratwani")
        self.assertEqual(remove_vowels("My best friend is pooh"), "My best friend pooh")
        self.assertEqual(remove_vowels("Hey I am rohan"), "Hey rohan")
        self.assertNotEqual(remove_vowels("sinchan is a boy"), "is boy")

    def test_check_pwd(self):
        """Function is used to test check_pwd"""
        self.assertEqual(check_pwd('1RohanR'), True)
        self.assertEqual(check_pwd('1Rohan'), False)
