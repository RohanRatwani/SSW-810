...
import unittest
from HW07_Rohan_Ratwani import anagrams_lst,anagrams_dd,anagrams_cntr,covers_alphabet,web_analyzer

class HW_07_Testcases(unittest.TestCase):
    ...
    def test_anagrams_lst(self):
        ...
        self.assertEqual(anagrams_lst("Rohan","nahor"),True)
    ...
    def test_anagrams_dd(self):
        ...
        self.assertEqual(anagrams_dd("Rohan","NahoR"),True)
    ...
    def test_anagrams_cntr(self):
        ...
        self.assertEqual(anagrams_cntr("Rohan","NAhoR"),True)
