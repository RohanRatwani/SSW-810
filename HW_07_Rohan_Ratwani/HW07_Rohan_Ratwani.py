...
'''Author: Rohan Ratwani
    HW07 this file contains different functions to check anagrams, if the string covers all alphabet and a web analyzer and what the specific function does is mentioned in their respective docstrings.'''
...
def web_analyzer(weblogs: List[Tuple[str, str]]) -> List[Tuple[str, List[str]]]:
    '''This function summarizes the dictionary in the form of key containing the website name and value has the person name who visited the website'''
